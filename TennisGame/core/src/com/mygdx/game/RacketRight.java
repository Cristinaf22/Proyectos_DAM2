...
/**
 * Gestiona el movimiento de la raqueta derecha
 */
public class RacketRight {

    private final Sprite sprite;
    private final Rectangle gameArea;
    private final World world;
    private Body body;
    public RacketRight(Texture texture, Rectangle gameArea, World world){
        ...
        sprite.setPosition(gameArea.getWidth() - racketOffset, gameArea.y + gameArea.getHeight() / 2 - sprite.getHeight() / 2);
        createBody();
    }
